#ifndef _VOLTAGERS_H_
#define _VOLTAGERS_H_
#include <wx/wx.h>
...
static wxImage voltagers_instrument_img;
static wxPanel* voltagers_instrument_rightpanel_ = nullptr;

class cVoltageRs : public wxFrame
{
private:
...
public:
	...
	cVoltageRs(wxWindow* inst, cDeviceMonitor* devmon);
	~cVoltageRs();
